...
<div class="text-center"><h4 style="color: #E86110;">Тарифы на междугороднюю и международную связь для абонентов Санкт-Петербурга</h4></div>
<br />
<br />
<table id="spb_rates_table" class="table table-striped table-bordered"  cellspacing="0" style="width: 100%">
<thead>
<tr>
...
{% for rate in m.lb[{rates_list tar_id="258"}] %}
{% if rate["prefix"] %}
<tr>
...
{% javascript %}
	...
	$(document).ready(function() {
		var oTable = $('#spb_rates_table').dataTable({
...
<br />
    <ul style="padding: 1em;">
        <li><a href="/lib/pdfs/vimpel_doverennost_spb.pdf">доверенность от ОАО &laquo;Вымпел-Коммуникации&raquo;&nbsp;Санкт-Петербург</a></li>
    </ul>
</div>
