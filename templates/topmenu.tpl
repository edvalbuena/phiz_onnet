          ...
          {% if not m.kazoo.is_auth %}
            ...
            <li id="sign-in">
              ...
              <div class="search-box hidden" id="forgot-pwd-box">
                {% wire id="forgottenpwd_form" type="submit" postback={forgottenpwd} delegate="mod_kazoo" %}
                <form id="forgottenpwd_form" class="input-group" method="post" action="postback">
                  ...
                  <input class="form-control mb-10" placeholder="{_ Phonenumber _}" type="text" id="forgotten_account_name"
                         name="forgotten_account_number" value=""  autofocus="autofocus" autocapitalize="off" autocomplete="on" tabindex=1>
